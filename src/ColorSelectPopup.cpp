...
$register_ids(ColorSelectPopup) {
    bool pauseMenu = !this->m_newColorTrigger;
    ...
    if (pauseMenu) {
        ...
        setIDSafe<CCScale9Sprite>(m_mainLayer, 1, "color-id-background");
        ...
        if (auto menu = setIDSafe<CCMenu>(m_mainLayer, 0, "menu")) {
            ...
            setIDSafe<CCMenuItemSpriteExtra>(menu, 4, "color-id-prev-button");
            setIDSafe<CCMenuItemSpriteExtra>(menu, 5, "color-id-next-button");
            setIDSafe<CCMenuItemSpriteExtra>(menu, 6, "special-color-id-select-button");
        ...
        if (auto menu = setIDSafe<CCMenu>(m_mainLayer, 0, "menu")) {
            ...
            setIDSafe<CCMenuItemSpriteExtra>(menu, 2, "paste-button");
            setIDSafe<CCMenuItemSpriteExtra>(menu, 3, "default-button");
            setIDSafe<CCMenuItemSpriteExtra>(menu, 4, "special-color-id-select-button");
            ...
            setIDSafe<CCMenuItemSpriteExtra>(menu, 9, "special-channel-id-select-button");
